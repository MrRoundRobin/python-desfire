...
class BackupDataFileSettings(FileSettings):
    def __init__(
        self,
        ...
        """
        Initialize the BackupDataFileSettings object
        ...
        super().__init__(DESFireFileType.MDFT_BACKUP_DATA_FILE, permissions, encryption)
