...
class LinearRecordFileSettings(FileSettings):
    def __init__(
        self,
        ...
        """
        Initialize the LinearRecordFileSettings object
        ...
        super().__init__(DESFireFileType.MDFT_LINEAR_RECORD_FILE_WITH_BACKUP, permissions, encryption)
